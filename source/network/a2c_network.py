...
class A2CNetwork(tf.keras.Model):
    def __init__(self, output_dim, mode="train"):
        ...
        # Operators
        self.bn_dense0 = Dense(64, activation="relu", name="bottle_neck_dense0")
        self.bn_dense1 = Dense(128, activation="relu", name="bottle_neck_dense1")

        self.action_dense0 = Dense(128, activation="relu", name="action_dense0")
        self.action_dense1 = Dense(output_dim, activation="tanh", name="action_dense1")
        self.action_dense2 = Dense(output_dim, activation="softplus", name="action_dense2")
